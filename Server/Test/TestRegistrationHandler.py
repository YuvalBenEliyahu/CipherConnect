...
class TestRegistrationHandler(unittest.TestCase):
    ...
    def test_handle_registration_success(self):
        ...
        payload = f"John,Doe,1234567890,Password1$,{public_key_pem}"
